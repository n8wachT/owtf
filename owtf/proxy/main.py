...
from owtf.constants import PROXY_LOG, INBOUND_PROXY_PORT, INBOUND_PROXY_IP, INBOUND_PROXY_CACHE_DIR, \
    OUTBOUND_PROXY_AUTH, USE_OUTBOUND_PROXY, INBOUND_PROXY_PROCESSES, CA_CERT, CA_KEY, CA_PASS_FILE, CERTS_FOLDER, \
    WHITELIST_COOKIES, BLACKLIST_COOKIES, HTTP_AUTH_HOST, HTTP_AUTH_USERNAME, HTTP_AUTH_PASSWORD, HTTP_AUTH_MODE, \
